          ...
          <div className="px-6 md:px-40">
            <div className="flex items-center justify-center mb-3.5 md:gap-11">
              <div className="flex flex-col items-center">
                <img src={`${CDN_BASE}/jack-front.png`} alt="Игрушка спереди" className="w-48 h-48 md:w-56 md:h-56 object-contain" />
              </div>

              <div className="flex flex-col items-center">
                <img src={`${CDN_BASE}/jack-side.png`} alt="Игрушка сбоку" className="w-48 h-48 md:w-56 md:h-56 object-contain" />
              </div>

              <div className="flex flex-col items-center">
                <img src={`${CDN_BASE}/jack-back.png`} alt="Игрушка сзади" className="w-48 h-48 md:w-56 md:h-56 object-contain" />
              </div>
            </div>

            <div className="flex flex-col gap-2 max-w-5xl">
              <div className="flex items-center gap-4">
                <span className="text-accent font-mono text-sm">Мастер</span>
                <span className="text-foreground font-mono text-sm">Ручное производство игрушек</span>
              </div>
              <div className="flex items-center gap-4">
                <span className="text-accent font-mono text-sm">Материал</span>
                <span className="text-foreground font-mono text-sm">Натуральные и безопасные материалы</span>
              </div>
              <div className="flex items-start gap-4">
                <span className="text-accent font-mono text-sm">О проекте</span>
                <span className="text-foreground font-mono text-sm">
                  Каждая игрушка — уникальная история. Создаю с любовью и вниманием к деталям, чтобы подарить радость детям и взрослым.
                </span>
              </div>
            </div>
          </div>
